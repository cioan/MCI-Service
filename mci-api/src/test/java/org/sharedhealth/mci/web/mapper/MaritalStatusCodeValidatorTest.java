...
public class MaritalStatusCodeValidatorTest extends BaseCodeValidatorTest<PatientDto> {

    @Test
    public void shouldPassForValidValues() throws Exception {
        String[] validStatuses = {"1", "2", "3", "4", "5"};
        assertValidValues(validStatuses, "maritalStatus", PatientDto.class);
    }

    @Test
    public void shouldFailForInvalidValues() throws Exception {
        String[] inValidRelations = {"", "some_invalid_code", "6", "0"};
        assertInvalidValues(inValidRelations, "maritalStatus", PatientDto.class);
    }
}