...
public class BloodGroupCodeValidatorTest extends BaseCodeValidatorTest<PatientDto> {

    @Test
    public void shouldPassForValidValues() throws Exception {
        String[] validStatuses = {"1", "8"};
        assertValidValues(validStatuses, "bloodGroup", PatientDto.class);
    }

    @Test
    public void shouldFailForInvalidValues() throws Exception {
        String[] inValidRelations = {"", "some_invalid_code", "00", "9"};
        assertInvalidValues(inValidRelations, "bloodGroup", PatientDto.class);
    }
}