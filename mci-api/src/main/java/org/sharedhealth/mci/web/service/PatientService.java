...
public class PatientService {
    ...
    public MCIResponse createOrUpdate(PatientDto dto) throws ExecutionException, InterruptedException {
        ...
        if (isNotBlank(hid)) {
            return patientRepository.update(hid, dto);
        }
    ...
    public List<PatientDto> findAllByLocations(List<String> locations, String last, Date since) {
        return patientRepository.findAllByLocations(locations, last, since);
    }

    public List<PatientDto> findAllByFacility(String facilityId, String last, Date since) {
